...
@section('content')
  ...
  <section class="content-header">
    <h1>Customer Pending Report</h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo \URL::route('dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li class="active">Customer Pending Report</li>
    </ol>
  </section>

  <!-- Main content -->
  <section class="content" data-ng-controller="vendorReportsController" data-ng-init="getVendorReport(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype,'','','','','');getVendorReportPlantList();">
    <div class="flash-message" ng-hide="msgDisplay">
      ...
      <span ng-cloak ng-view='danger' ng-bind='danger' class="alert alert-danger" ng-show="danger"></span>
       ...
       <form ng-submit="getVendorReport(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype,challanStatus,pendingPeriod,plant,datefilter,dateRangeValue)">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <button type="button" class="btn btn-primary" ng-click="getVendorReport(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype,'','','','','');getVendorReportPlantList();clearData();">Reset</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="box-body">
            ...
            <div class="align_right" ng-hide="total == 0">
              ...
              <div class="table-responsive no-padding" id="pdfDataHolder">
                ...
                <table class="table table-bordered table-hover" id="tableContainer"  border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                  ...
                  <tr ng-hide="total == 0" style="text-align: center;font-size: 20px; background: #BEE8F5">
                    ...
                    <td colspan="1">@{{records[0]['noOfTrips']}}</td>
                    <td colspan="5">&nbsp;</td>
                  </tr>
              ...
              <div paging
                ...
                paging-action="getVendorReport(page, paginationControl.orderby, paginationControl.ordertype,challanStatus,pendingPeriod,plant,datefilter,dateRangeValue)">
              </div> 
        </div> 
      </div>
  </section>
