...
@section('content')
    ...
    <div data-ng-controller="vendorsController" data-ng-init="getQueryString();getBankList();">  
          ...
          <div class="box-body">
            <form ng-submit="saveVendor();" id="vendorForm" name="vendorForm">
              ...
              <div class="form-group has-feedback">
                ...
                <!--<select ng-model="selectBank" name="selectBank" ng-options="bankRecord.id as bankRecord.name for bankRecord in bankRecords" class="form-control" required ng-change="bankChanged();getBankifscDetails(selectBank);">-->
              ...
              <div class="row submit-button-holder">
                ...
                <div class="col-xs-4">
                 ...
                 <a onclick="javascript:window.history.back();" class="btn btn-default btn-flat">Back</a>
