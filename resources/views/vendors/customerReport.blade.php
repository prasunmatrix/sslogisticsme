          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-3"> 
                ...
                <div class="form-group">
                  <input type="text" class="form-control date-picker right-aligned" name="datefilter" id="datefilter" ng-model="datefilter"/>
