...
@section('content')
  ...
  <!-- Main content -->
  <section class="content" data-ng-controller="ApprovalManageController" data-ng-init="misclleneousList(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype, paginationControl.searchKeyword);">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <input type="text" class="form-control"  name="searchKeyword" id="searchKeyword" placeholder="Search" ng-model="searchKeyword" maxlength="100" ng-change="misclleneousList(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype, searchKeyword)" ng-keyup="misclleneousList(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype, searchKeyword)">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="box-body">
            ...
            <div class="table-responsive no-padding">
              <table class="table table-bordered table-hover">
                <tr>
                  <th width="6%">
                      <a ng-click="misclleneousList(paginationControl.currentPage,'id',changedOrderType,paginationControl.searchKeyword)" style="cursor: pointer;">ID</a>
                  ...
                  <th width="12%">
                      <a ng-click="misclleneousList(paginationControl.currentPage,'name',changedOrderType,paginationControl.searchKeyword)" style="cursor: pointer;">Plant Name</a>
                  ...
                  <th width="12%">
                      <a ng-click="misclleneousList(paginationControl.currentPage,'full_name',changedOrderType,paginationControl.searchKeyword)" style="cursor: pointer;">Added By</a>
                  ...
                  <th width="14%">Approval/Disapproval Reason</th>
                  <th width="14%">@if(\Auth::user()->user_role_id == \Config::get('constants.supervisorRoleId')) Status @else Action @endif</th>
                </tr>
                    ...
                    <td>
                      ...
                      @else
                        <span ng-if="row.approval_status == 'Pending'">
                         <!--<a ng-click="approveMisclleneous(row.id,paginationControl.currentPage,paginationControl.orderby,paginationControl.ordertype,paginationControl.searchKeyword)"><button type="button" class="btn btn-primary btn-sm active" title="Approve"><i class="{{\Config::get('constants.checkIcon')}}" aria-hidden="true"></i></button></a>-->
            ...
            <div paging
              ...
              paging-action="misclleneousList(page, paginationControl.orderby, paginationControl.ordertype, paginationControl.searchKeyword)">
            </div>
          </div> 
        </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form ng-submit="miscChangeApproval();" id="reason" name="reasonForm">
