...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Diesel List</li>
    </ol>
  </section>

  <!-- Main content -->
  <section class="content" data-ng-controller="ApprovalManageController" data-ng-init="dieselList(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype, paginationControl.searchKeyword);">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <input type="text" class="form-control"  name="searchKeyword" id="searchKeyword" placeholder="Search" ng-model="searchKeyword" maxlength="100" ng-change="dieselList(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype, searchKeyword)" ng-keyup="dieselList(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype, searchKeyword)">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="box-body">
            ...
            <div class="table-responsive no-padding">
              <table class="table table-bordered table-hover">
                <tr>
                  <th th width="5%">
                      <a ng-click="dieselList(paginationControl.currentPage,'id',changedOrderType,paginationControl.searchKeyword)" style="cursor: pointer;">ID</a>
                  ...
                  <th width="9%">
                      <a ng-click="dieselList(paginationControl.currentPage,'trip_id',changedOrderType,paginationControl.searchKeyword)" style="cursor: pointer;">Trip ID</a>
                  ...
                  <th width="9%">
                      <a ng-click="dieselList(paginationControl.currentPage,'petrol_pump_name',changedOrderType,paginationControl.searchKeyword)" style="cursor: pointer;">Petrol Pump Name</a>
                  ...
                  <th width="9%">
                      <a ng-click="dieselList(paginationControl.currentPage,'truck_no',changedOrderType,paginationControl.searchKeyword)" style="cursor: pointer;">Truck No.</a>
                  ...
                  <th width="9%">
                      <a ng-click="dieselList(paginationControl.currentPage,'full_name',changedOrderType,paginationControl.searchKeyword)" style="cursor: pointer;">Added By</a>
                  ...
                  <th width="10%">Previous Diesel Amount</th>    
                  <th width="10%">Requested Diesel Amount</th> 
                  <th width="12%">Current Diesel Amount</th>  
                ...
                <tr ng-repeat="row in records">
                    ...
                    <td>@{{row.diesel_amount | number : 2}}</td>
                    ...
                    <td>
                      ...
                      @else
                        <span ng-if="row.approval_status == 'Pending'">
                         <!--<a ng-click="approveDiesel(row.id,paginationControl.currentPage,paginationControl.orderby,paginationControl.ordertype,paginationControl.searchKeyword)"><button type="button" class="btn btn-primary btn-sm active">Approve</button></a> <a ng-click="disapproveDiesel(row.id,paginationControl.currentPage,paginationControl.orderby,paginationControl.ordertype,paginationControl.searchKeyword)"><button type="button" class="btn btn-danger btn-sm active">Disapprove</button></a>-->
            ...
            <div paging
              ...
              paging-action="dieselList(page, paginationControl.orderby, paginationControl.ordertype, paginationControl.searchKeyword)">
            </div>
          </div> 
        </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form ng-submit="dslChangeApproval();" id="reason" name="reasonForm">
