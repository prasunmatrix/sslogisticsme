...
@section('content')
    ...
    <div  data-ng-controller="plantsController" data-ng-init="getAddressZoneListing();">
          ...
          <div class="box-body">
            <form ng-submit="savePlant();" id="plantForm" name="plantForm">
              ...
              <div class="form-group has-feedback">
                ...
                <select ng-model="selectAddressZone" name="selectAddressZone" ng-options="addressZoneRecord.id as addressZoneRecord.title for addressZoneRecord in addressZoneRecords" id="selectAddressZone" class="form-control" required >
              ...
              <div class="row submit-button-holder">
                ...
                <div class="col-xs-4">
                 <a class="btn btn-default btn-flat" href=<?php echo url(''); ?>/plants>Back</a>
