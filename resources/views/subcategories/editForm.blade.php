...
@section('content')
  ...
  <div data-ng-controller="subcategoriesController" data-ng-init="subcategoryEdit();">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form ng-submit="saveSubcategory();" id="subcategoryForm" name="subcategoryForm">
             {{csrf_field()}}
            <input type="hidden" name="subcategoryId" ng-model="subcategoryId"> 
            ...
            <div class="row submit-button-holder">
              ...
              <div class="col-xs-4">
                <a href="<?php echo URL('');?>/subcategories" class="btn btn-default btn-flat">Back</a>
