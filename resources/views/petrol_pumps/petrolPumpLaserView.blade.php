...
@section('content')
  ...
  <section class="content-header">
    <h1>Petrol Pump Laser</h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo \URL::route('dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li class="active">Petrol Pump Laser</li>
    </ol>
  </section>

  <!-- Main content -->
  <section class="content" data-ng-controller="PetrolpumpLaserController" data-ng-init="viewSelectedPetrolpumpLaser({{$petrolpump_id}},{{$year}});">
    <div class="flash-message" ng-hide="msgDisplay">
      ...
      <form ng-submit="searchPetrolpumpLaser({{$year}},{{$petrolpump_id}});" id="PetrolpumpLaserForm" name="PetrolpumpLaserForm">
              ...
              <div class="col-xs-7">
                <div class="form-group">
                  ...
                  data-ng-options="item for item in years" class="form-control" required>
                   ...
                   <span class="invalidInputErrorClass" ng-show="PetrolpumpLaserForm.selectYear.$touched && PetrolpumpLaserForm.selectYear.$error.required">Please Select Year</span>
                </div>
              </div>
              <div class="col-xs-5">
                <div class="form-group">
                  <button type="submit" ng-disabled="PetrolpumpLaserForm.$invalid" class="btn btn-primary">Submit</button>
                  <a href="<?php echo URL('');?>/petrolpump-laser-view" class="btn btn-default btn-flat">Back</a>
                </div>
              </div>
              </div>
            </div>
        ...
        <div class="box-body">
            <div class="table-responsive no-padding">
              <table class="table table-bordered table-hover" id="tableContainer">
                ...
                <tr ng-show="(records).length > 0">
                  <td colspan="3" class="right amount">@{{balance > 0 ? 'Credit balance - ':'Debit balance - '}} Rs. @{{balance | number : 2}}</td>
                </tr>
