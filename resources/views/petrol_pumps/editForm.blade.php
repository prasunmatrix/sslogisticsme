...
@section('content')
      ...
      <li class="active">Edit Petrol Pump</li>
        </ol>
      </section>
      <!-- Main content -->
      
  <div data-ng-controller="petrolPumpsController" data-ng-init="petrolPumpEdit();getAddressZoneListing();">
    ...
    <section class="content">
      ...
      <div class="box" >
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Edit Petrol Pump</h3>
