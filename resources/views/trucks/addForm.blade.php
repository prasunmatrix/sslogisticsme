...
@section('content')
      ...
      <div data-ng-controller="trucksController" data-ng-init="checkDate();getAllVendorList();selectVendor();">
                      ...
                      <div class="submit-button-holder col-md-2 col-xs-12">
                        <label class="labelHeight">&nbsp;</label>
                          ...
                          <div class="col-md-12 col-xs-12">
                            ...
                            <hr>
                            <div class="row">
                              <div class="col-xs-12 labelwithcheck">
                                <label>Active:- </label>
                        ...
                        <!-- <input type="hidden" ng-model="selectType" name="selectType" id="selectType">
                        <label>OR</label><br>
                        <a href="{{ asset('/view-vendor-add-form') }}?q=addNew">Add New Company</a>

                        <br><br>
                        <div class="active_checkbox col-md-12">
                          <label>Active:- </label>
                          <input type="checkbox" name="status" ng-model="status" ng-checked="status == '1'" ng-true-value="'A'" ng-false-value="'I'" >
                        </div> -->
