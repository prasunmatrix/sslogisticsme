...
@section('content')
      ...
      <li class="active">Edit Plant Address</li>
        </ol>
      </section>
      <!-- Main content -->
      
    <div data-ng-controller="plantAddressesController" data-ng-init="plantAddressEdit();">
      ...
      <section class="content">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Edit PlantAddress</h3>
            
          </div>
          <div class="box-body">
            <form ng-submit="savePlantAddress();" id="plantAddressForm" name="plantAddressForm">
              {{csrf_field()}}
              <input type="hidden" name="plantAddressId" ng-model="plantAddressId"> 
