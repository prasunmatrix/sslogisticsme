...
@section('content')
      ...
      <li class="active">Edit AddressZone</li>
        </ol>
      </section>
      <!-- Main content -->
        ...
        <div class="box">
         <div class="flash-message" ng-hide="msgDisplay">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Edit AddressZone</h3>
            
          </div>
          <div class="box-body">
            <form action="{{ asset('save-addressZone') }}" id="addressZoneForm" name="addressZoneForm">
              {{csrf_field()}}
              <input type="hidden" name="addressZoneId" value="{{$addressZoneDetails['id']}}"> 

              <div class="form-group has-feedback">
                <label>Title</label>
                <input type="text" class="form-control" placeholder="Title" name="title" ng-maxlength="255" value="{{$addressZoneDetails['title']}}" required/>
              ...
              <div class="form-group has-feedback">
                <label>Address</label>
                <input type="text" class="form-control" placeholder="Address" name="addressZoneAddress" value="{{$addressZoneDetails['address']}}" id="addressZoneAddress" ng-maxlength="255" required/>
              ...
              <input type="hidden" name="latitude" id="latitude" value="{{$addressZoneDetails['latitude']}}">
              <input type="hidden" name="longitude" id="longitude" value="{{$addressZoneDetails['longitude']}}" >

              <input type="hidden" name="currentPageNo" id="currentPageNo" value="{{$pageNo}}">
