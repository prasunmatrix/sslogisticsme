...
@section('content')
      ...
      <section class="content-header">
        <h1>
          Edit Party Destination   
        </h1>
        <ol class="breadcrumb">
          <li><a href="<?php echo \URL::route('dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li class="active">Edit Party Destination</li>
        </ol>
      </section>
      <!-- Main content -->
      
    <div  data-ng-controller="partyDestinationsController" data-ng-init="partyDestinationEdit();">  
      ...
      <section class="content">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Edit PartyDestination</h3>
            
          </div>
          <div class="box-body">
            <form ng-submit="savePartyDestination();" id="partyDestinationForm" name="partyDestinationForm">
               {{csrf_field()}}
              <input type="hidden" name="partyDestinationId" ng-model="partyDestinationId"> 
              ...
              <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Contact Number" name="contactNumber" ng-model="contactNumber" maxlength="10" onkeypress="return keyRestrict(event,'1234567890')" ng-pattern="phoneNumberPattern" required/>
