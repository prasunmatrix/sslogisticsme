...
@section('content')
     ...
     <div data-ng-controller="tripsController" data-ng-init="tripEdit();">
                ...
                <div class="col-md-12 col-xs-12">
                  <div class="trip_form">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group has-feedback">
                          ...
                          <select ng-model="disableTripType" name="disableTripType" class="form-control" required disabled="disabled">
                          ...
                          <input type="hidden" name="tripType" ng-model="tripType" id="tripType">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group has-feedback">
                          ...
                          <div class="date taxEnd">
                            ...
                            <input type="text" class="form-control" customdatepickershow placeholder="Trip Date" name="tripDate" ng-model="tripDate" id="tripDate" ng-maxlength="255" required readonly/>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group has-feedback">
                          <label>Status</label>&nbsp;<span class="redAsterisk">*</span>
                          &nbsp;&nbsp;
                          
                          <select ng-model="tripStatus" name="tripStatus" id="tripStatus" class="form-control" required>
              ...
              <div class="row">
                <div class="col-md-12 col-xs-12">
                  <div class="trip_form">
                    ...
                    <!--<div class="row" ng-show="ADVeditReqCount = 0">
                      <div class="col-sm-12">
                        <div class="form-group has-feedback">
                           <label>Advance Amount</label>
                            ...
                            <span class="invalidInputErrorClass" ng-cloak ng-show="tripForm.advanceAmount.$error.pattern">The Advance Amount is invalid.</span>
                        </div>
                      </div>
                    </div>-->
                ...
                <div class="col-md-12 col-xs-12">
                  <div class="trip_form">
                      ...
                      <div class="row">
                        ...
                        <!--<div class="col-sm-6" ng-show="DSLeditReqCount = 0">
                          <div class="form-group has-feedback">
                          <label>Diesel Amount</label>
                              ...
                              <span class="invalidInputErrorClass" ng-cloak ng-show="tripForm.dieselAmount.$error.pattern">The Diesel Amount is invalid.</span>
                          </div>
                        </div>-->
                         <div class="col-sm-6">
                          <div class="form-group has-feedback">
                        ...
                        <div class="box-body">
                          <form ng-submit="saveTripPlant();" id="plantForm" name="plantForm">
                            ...
                            <div class="form-group has-feedback">
                              ...
                              <span class="invalidInputErrorClass" ng-show="plantForm.selectAddressZone.$touched && plantForm.selectAddressZone.$error.required">Please select the Address Zone</span>
                            </div>
