...
@section('content')
  ...
  <!-- Main content -->
  <section class="content" data-ng-controller="ledgerReportsController" data-ng-init="getLedgerReport(paginationControl.currentPage, paginationControl.orderby, paginationControl.ordertype,'','');getVendorList(); ">
