...
@section('content')
      ...
      <li class="active">Pay Extra Diesel</li>
        </ol>
      </section>
      <!-- Main content -->
      
    <div data-ng-controller="extraCashDieselsController" data-ng-init="getCashPlantList();getCashVendorList(); getDieselPetrolPumpList();">  
        ...
        <div class="box">
         <div class="flash-message" ng-hide="msgDisplay">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Pay Extra Diesel</h3>
