...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
  ...
  <tr>
    ...
    <td width="15%" align="right" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:11px; color:#000; padding:3px; text-align:right;">Duplicate</td>
  </tr>
  <tr>
...
<!--<div style="width:99%; border: 1px solid black; box-sizing: content-box; height:300px; text-align: center; vertical-align: middle; line-height: 300px; font-weight: bold; font-size: 25px;"> 
    Intentionally Left Blank 
</div>-->

<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
  <tr>
    <td align="left" valign="top" style="border: 1px solid #000; border-collapse: collapse; height:330px; text-align: center; vertical-align: middle; line-height: 330px; font-weight: bold; font-size: 25px;">Intentionally Left Blank </td>
  </tr>
</table>
