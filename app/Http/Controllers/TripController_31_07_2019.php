...
class TripController extends Controller {
	...
	public function getTcPdf(Request $request){
		...
		$originalHtmlData1 = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		...
		<table width="100%" border="0" align="center" cellpadding="10" cellspacing="0" style="border-collapse: collapse;">
		  ...
		  <tr>
		    <td style="font-family: Arial, Helvetica, sans-serif; font-size:11px; color:#000; font-weight: bold; text-align:center; padding:3px 0 0 0;">'.$record['tripDetails']['plant_name'].'</td>
		  </tr>
		  <tr>
						<td width="100%" align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px;line-height:14px; color:#000; text-align:center; padding:3px 0;">11/5/1 Cossipore Road, Kolkata, West Bengal - 700002<br />
						Phone: +91 9007759038, +91 98365 82274, Email- info@sslogistics.org<br />
		...
		<table width="100%" border="0">
		  <tr>
		    ...
		    <td width="33%" align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; line-height:14px; color:#000; padding:3px 5px;">'.date_format(date_create($record['tripDetails']['trip_date']),'d-m-Y :: H:i:s a').'</td>
		  </tr>
		  <tr>
		    ...
		    <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; line-height:14px; padding:3px 5px;">'.$record['tripDetails']['truck_owner'].'</td>
		    <td align="left" valign="top">&nbsp;</td>
		    <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; line-height:14px; padding:3px 5px;">Trip No:</td>
		    <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; line-height:14px; padding:3px 5px;">SSLT000'.$record['tripDetails']['id'].'</td>
		  </tr>
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse;">
		  ...
		  <tr>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; padding:3px 5px; border:1px solid #000; border-left:none;">'.$record['tripDetails']['truck_no'].'</td>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; padding:3px 5px; border:1px solid #000;">'.$record['tripDetails']['quantity'].'</td>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; padding:3px 5px; border:1px solid #000;">'.$record['tripDetails']['party_name'].'</td>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; padding:3px 5px; border:1px solid #000;">'.$record['tripDetails']['end_location'].'</td>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; padding:3px 5px; border:1px solid #000; border-right:none;">'.$record['tripDetails']['advance_amount'].'</td>
		    </tr>
		</table>
		<table width="100%" border="0">
		  ...
		  <tr>
		    <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; padding:3px 5px;">Amount in Words: '.$advanceAmountInWords.' </td>
				</tr>
				<tr>
						<td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; color:#000; padding:3px 5px;">&nbsp;</td>
					</tr>
		...
		/*page break in pdf*/
		PDFTC::writeHTML($originalHtmlData1, true, false, true, false, '');
		PDFTC::AddPage();

		$originalHtmlData2 = '<table width="100%" border="0" align="center" cellpadding="10" cellspacing="0" style="border-collapse: collapse;">
		  <tr>
		    <td align="left" valign="top" style="border: 1px solid #000; border-collapse: collapse;">
		    	<table width="100%" border="0" >
		  <tr>
		  ...
		  <tr>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; line-height:14px; color:#000; padding:3px 5px; border:1px solid #000; border-left:none;">SSLT000'.$record['tripDetails']['id'].'</td>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; line-height:14px; color:#000; padding:3px 5px; border:1px solid #000;">'.date_format(date_create($record['tripDetails']['trip_date']),'d-m-Y :: H:i:s a').'</td>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; line-height:14px; color:#000; padding:3px 5px; border:1px solid #000;">'.$record['tripDetails']['lr_no'].'</td>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; line-height:14px; color:#000; padding:3px 5px; border:1px solid #000;">'.$record['tripDetails']['truck_no'].'</td>
		    <td align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:9px; line-height:14px; color:#000; padding:3px 5px; border:1px solid #000; border-right:none;">'.$record['tripDetails']['diesel_amount'].'</td>
		    </tr>
		</table>
		   	  <table width="100%" border="0">
		      <tr>
		...
		/*page break in pdf*/
		PDFTC::writeHTML($originalHtmlData2, true, false, true, false, '');
		PDFTC::AddPage();
	...
	public function getLedgerReport(Request $request) {
		...
		/*get available records*/
		$ledgerReportList = TripBill::getLedgerReport($dbTables,$request->currentPage,$request->perPageRecord,$request->orderby,$request->ordertype,$request->company);
		$totalLedgerReports = TripBill::totalLedgerReportRecords($dbTables,$request->company);
